...
echo "<table border=0><tr><td>Name</td><td>Price</td><td>Image</td><td>Description</td><td>Delete</td><td>Edit</td></tr>";
while ($row = $res->fetch_assoc()) {
	...
	echo "<td><a rel='external' href='edittrends.php?pass=hello&action=edit&id={$row['id']}'data-role='button' data-icon='plus'>Edit</a></td></tr>";
