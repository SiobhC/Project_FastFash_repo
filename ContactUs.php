<!-- able to insert a username from a form, with question and email-->
<!-- Working Friday 7th march-->
...
/* prepare statement */
if ($stmt = mysqli_prepare($link, "INSERT INTO comments  (first_name,last_name, email,category, message) VALUES('{$_POST['first_name']}','{$_POST['last_name']}',('{$_POST['email']}'),('{$_POST['category']}'),'{$_POST['comments']}');")) {
	$stmt->execute();
    /* fetch values */
    while (mysqli_stmt_fetch($stmt)) {
        //printf("%s %s %s \n",$_POST['first_name'],$_POST['last_name'],$_POST['email'],$_POST['category'] $_POST['message']);
    }
