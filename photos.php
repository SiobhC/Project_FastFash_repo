...
if(isset($_GET["u"])){
    ...
    header("location: http://danu6.it.nuigalway.ie/siobhancollins");
    exit();	
} 
...
if($u == $log_username && $user_ok == true){
	...
	$photo_form .=   '<input type="file" name="photo" accept="image/*" required>';$photo_form .=   '<p><input type="submit" value="Upload Photo Now"></p>';
	$photo_form .= '</form>';
}
