...
<div data-role="controlgroup" data-type="horizontal" data-mini="true">
    <a rel="external" href="newCloset.php" data-role="button" data-icon="plus" data-theme="b">Add</a>
...
while ($row = $res->fetch_assoc()) {
	...
	echo "<td><a rel='external' href='editCloset.php?pass=hello&action=edit&id={$row['id']}' data-role='button' data-icon='plus'>Edit</a></td>";
  	echo "<td><a rel='external' href='newCloset.php' data-role='button' data-icon='plus' data-theme='b'>Add</a></td></tr>";
