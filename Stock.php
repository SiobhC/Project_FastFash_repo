<!--Stock page working, modify to allow add, i.e insert stock into the page-->
...
echo "<table border=1><tr><td>Name</td><td>Price</td><td>Units in Stock</td><td>Image</td><td>Description</td></tr>";
